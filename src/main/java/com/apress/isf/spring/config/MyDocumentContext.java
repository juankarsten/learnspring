...
import com.apress.isf.java.data.DocumentRepository;
import com.apress.isf.java.model.Document;
import com.apress.isf.java.model.Type;
import com.apress.isf.java.service.LocalSearchEngine;
...
public class MyDocumentContext {
	...
	public SearchEngine searchEngine(){
		SearchEngine searchEngine = new LocalSearchEngine();
		searchEngine.setDocumentDAO(documentDAO());
		return searchEngine;
	}
	
	@Bean
	public Type getType(){
		return types.get("web");
	}
